...
var author$project$RageGuy$Neutral = {$: 'Neutral'};
var elm$core$Basics$False = {$: 'False'};
var author$project$RageGuy$initialModel = {isMoodInTransition: false, isRaging: false, lastRelativeFrame: 0, mood: author$project$RageGuy$Neutral, targetAnger: 0, thisMoodClock: 0};
...
var author$project$Main$initialModel = {
	angerFlash: 0.0,
	discussion: _List_Nil,
	message: '',
	nextFetchMessages: elm$time$Time$millisToPosix(0),
	rageGuy: author$project$RageGuy$initialModel,
...
var author$project$Discussion$MessagesList = function (a) {
...
var author$project$Discussion$decoderMessage = A5(
	elm$json$Json$Decode$map4,
	author$project$Discussion$Message,
...
var author$project$Discussion$messageApiUrl = 'https://fffuuu-c42f.restdb.io/rest/messages';
...
var author$project$Discussion$fetchMessagesCmd = function (query) {
	var url = author$project$Discussion$messageApiUrl + '?q={}&h={\"$orderby\": {\"timestamp\": -1}, \"$max\": 200}';
	return elm$http$Http$request(
		{
			...
			expect: A2(
				...
				author$project$Discussion$MessagesList,
				elm$json$Json$Decode$list(author$project$Discussion$decoderMessage)),
			headers: _List_fromArray(
				[author$project$Discussion$apiKeyHeader]),
			method: 'GET',
...
var author$project$Discussion$MessagePosted = function (a) {
	return {$: 'MessagePosted', a: a};
};
...
var author$project$Discussion$encodeMessage = function (message) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'username',
				elm$json$Json$Encode$string(message.username)),
				_Utils_Tuple2(
				'timestamp',
				...
				_Utils_Tuple2(
				'topic',
				elm$json$Json$Encode$string(message.topic)),
				_Utils_Tuple2(
				'message',
				elm$json$Json$Encode$string(message.message))
			]));
};
var author$project$Discussion$postMessageCmd = function (message) {
	return elm$http$Http$request(
		{
			body: elm$http$Http$jsonBody(
				author$project$Discussion$encodeMessage(message)),
			expect: A2(elm$http$Http$expectJson, author$project$Discussion$MessagePosted, author$project$Discussion$decoderMessage),
			headers: _List_fromArray(
				[author$project$Discussion$apiKeyHeader]),
			method: 'POST',
			timeout: elm$core$Maybe$Nothing,
			tracker: elm$core$Maybe$Nothing,
			url: author$project$Discussion$messageApiUrl
		});
};
var author$project$Main$DiscussionMsg = function (a) {
	return {$: 'DiscussionMsg', a: a};
};
var author$project$Discussion$httpErrorToString = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var string = error.a;
...
var author$project$Main$restDbError = F3(
	function (description, httpError, time) {
		return {
			message: author$project$Discussion$httpErrorToString(httpError),
			timestamp: time,
			topic: description,
...
var author$project$RageGuy$Annoyed = {$: 'Annoyed'};
var author$project$RageGuy$Drooling = {$: 'Drooling'};
var author$project$RageGuy$FFFUUU = {$: 'FFFUUU'};
var author$project$RageGuy$Pissed = {$: 'Pissed'};
var author$project$RageGuy$VergeOfExplosion = {$: 'VergeOfExplosion'};
var author$project$RageGuy$angerToMood = F2(
	function (anger, isRaging) {
		return isRaging ? author$project$RageGuy$FFFUUU : ((anger < 0.1) ? author$project$RageGuy$Neutral : ((anger < 0.25) ? author$project$RageGuy$Annoyed : ((anger < 0.5) ? author$project$RageGuy$Pissed : ((anger < 0.8) ? author$project$RageGuy$Drooling : author$project$RageGuy$VergeOfExplosion))));
	});
var author$project$RageGuy$nextMood = function (mood) {
	switch (mood.$) {
		case 'Neutral':
			return author$project$RageGuy$Annoyed;
		case 'Annoyed':
			return author$project$RageGuy$Pissed;
		case 'Pissed':
			return author$project$RageGuy$Drooling;
		case 'Drooling':
			return author$project$RageGuy$VergeOfExplosion;
		case 'VergeOfExplosion':
			return author$project$RageGuy$FFFUUU;
		default:
			return author$project$RageGuy$FFFUUU;
	}
};
var author$project$RageGuy$isMoodBefore = F2(
	function (mood1, mood2) {
		isMoodBefore:
		while (true) {
			if (_Utils_eq(mood1, author$project$RageGuy$FFFUUU)) {
				return false;
			} else {
				if (_Utils_eq(
					author$project$RageGuy$nextMood(mood1),
					mood2)) {
					return true;
				} else {
					var $temp$mood1 = author$project$RageGuy$nextMood(mood1),
						$temp$mood2 = mood2;
					mood1 = $temp$mood1;
					mood2 = $temp$mood2;
					continue isMoodBefore;
				}
			}
		}
	});
...
var author$project$RageGuy$framesDefinition = function (mood) {
	var sequence = function (list) {
		return A2(
			elm$core$List$map,
			function (x) {
				return _Utils_Tuple2(x, x + 1);
			},
			list);
	};
	var reverse = elm$core$List$reverse;
	var repeat = F2(
		function (count, list) {
			return elm$core$List$concat(
				A2(elm$core$List$repeat, count, list));
		});
	var mapRangeTo = F2(
		function (list, target) {
			return A2(
				elm$core$List$map,
				function (x) {
					return _Utils_Tuple2(x, target);
				},
				list);
		});
	var rangeAndSequence = F2(
		function (staticCount, transitionCount) {
			return elm$core$List$concat(
				_List_fromArray(
					[
						A2(
						mapRangeTo,
						A2(elm$core$List$range, 0, staticCount - 1),
						staticCount),
						sequence(
						A2(elm$core$List$range, staticCount, transitionCount + staticCount))
					]));
		});
	switch (mood.$) {
		case 'Neutral':
			var upBlink = _List_fromArray(
				[11, 12]);
			var up = _List_fromArray(
				[8, 9, 10]);
			var transitions = elm$core$List$concat(
				_List_fromArray(
					[
						A2(
						mapRangeTo,
						...
						5),
						sequence(
						A2(elm$core$List$range, 5, 7)),
						A2(
						mapRangeTo,
						A2(elm$core$List$range, 8, 12),
						13),
						_List_fromArray(
						[
							_Utils_Tuple2(13, 14)
			...
			var downToUp = _List_fromArray(
				[5, 6, 7]);
			var downBlink = _List_fromArray(
				[3, 4]);
			var down = _List_fromArray(
				[0, 1, 2]);
			var staticFrames = elm$core$List$concat(
				_List_fromArray(
					[
						A2(repeat, 5, down),
						downBlink,
			...
			return {
				...
				transitions: elm$core$Dict$fromList(transitions)
			};
		case 'Annoyed':
			return {
				staticFrames: _List_fromArray(
					[0, 1, 2]),
				transitions: elm$core$Dict$fromList(
					A2(rangeAndSequence, 3, 6))
			};
		case 'Pissed':
			var up = _List_fromArray(
				[6, 7, 8]);
			var transitions = elm$core$List$concat(
				_List_fromArray(
					[
						...
						A2(
						mapRangeTo,
						A2(elm$core$List$range, 6, 8),
						9),
						sequence(
						A2(elm$core$List$range, 9, 10))
					]));
			var downToUp = _List_fromArray(
				[3, 4, 5]);
			var upToDown = reverse(downToUp);
			var down = _List_fromArray(
				[0, 1, 2]);
			var staticFrames = elm$core$List$concat(
				_List_fromArray(
			...
			var transitions = elm$core$List$concat(
				_List_fromArray(
					[
						...
						11),
						sequence(
						A2(elm$core$List$range, 11, 13))
					]));
			var openToClose = _List_fromArray(
				[5]);
			var openEyes = _List_fromArray(
				[0, 1, 2, 3, 4]);
			var closesToOpen = reverse(openToClose);
			var closedEyes = _List_fromArray(
				[6, 7, 8, 9, 10]);
			var staticFrames = elm$core$List$concat(
				_List_fromArray(
					[
						A2(repeat, 12, openEyes),
						openToClose,
						A2(repeat, 3, closedEyes),
						closesToOpen,
						A2(repeat, 7, openEyes),
						openToClose,
						A2(repeat, 8, closedEyes),
						closesToOpen,
						A2(repeat, 3, openEyes),
						openToClose,
						A2(repeat, 1, closedEyes),
						closesToOpen
					]));
			return {
				staticFrames: staticFrames,
		...
		case 'VergeOfExplosion':
			...
			var staticFrames = elm$core$List$concat(
				_List_fromArray(
					[
						A2(repeat, 6, openEyes),
						openToClose,
						A2(repeat, 2, closedEyes),
						closesToOpen,
						A2(repeat, 5, openEyes),
						openToClose,
						A2(repeat, 8, closedEyes),
						closesToOpen,
						A2(repeat, 3, openEyes),
		...
		default:
			return {
				staticFrames: _List_fromArray(
					[0, 1, 2]),
				transitions: elm$core$Dict$empty
			};
	}
};
var author$project$RageGuy$maybeMoodTransitionFrameAfter = F2(
	function (lastFrame, mood) {
		return A2(
			elm$core$Dict$get,
			lastFrame,
			author$project$RageGuy$framesDefinition(mood).transitions);
	});
...
var author$project$RageGuy$relativeFrameForStaticMood = F2(
	function (thisMoodClock, mood) {
		var cycle = elm$core$Array$fromList(
			author$project$RageGuy$framesDefinition(mood).staticFrames);
		return A2(
...
var author$project$RageGuy$update = F2(
	function (msg, model) {
		if (msg.$ === 'Tick') {
			var targetMood = A2(author$project$RageGuy$angerToMood, model.targetAnger, model.isRaging);
			var newModel = function () {
				if (model.isMoodInTransition) {
					if (A2(author$project$RageGuy$isMoodBefore, model.mood, targetMood)) {
						var _n1 = A2(author$project$RageGuy$maybeMoodTransitionFrameAfter, model.lastRelativeFrame, model.mood);
						if (_n1.$ === 'Just') {
							var nextFrame = _n1.a;
							return _Utils_update(
								model,
								{lastRelativeFrame: nextFrame});
						} else {
							return _Utils_update(
								model,
								{
									...
									lastRelativeFrame: 0,
									mood: author$project$RageGuy$nextMood(model.mood),
									thisMoodClock: 0
								});
						}
					} else {
					...
					if (_Utils_eq(model.mood, targetMood)) {
						return _Utils_update(
							model,
							{
								lastRelativeFrame: A2(author$project$RageGuy$relativeFrameForStaticMood, model.thisMoodClock, model.mood),
								thisMoodClock: model.thisMoodClock + 1
							});
					} else {
						return _Utils_update(
							model,
							{isMoodInTransition: true});
					}
				}
			}();
			return newModel;
			...
			return _Utils_update(
				model,
				{targetAnger: model.targetAnger + amount});
		}
	});
var author$project$SwearWords$translationList = _List_fromArray(
	[
		_Utils_Tuple2('äæǽ', 'ae'),
		_Utils_Tuple2('öœ', 'oe'),
		_Utils_Tuple2('ü', 'ue'),
		_Utils_Tuple2('Ä', 'Ae'),
		_Utils_Tuple2('Ü', 'Ue'),
		_Utils_Tuple2('Ö', 'Oe'),
		_Utils_Tuple2('ÀÁÂÃÄÅĀĂĄǍΑΆẢẠẦẪẨẬẰẮẴẲẶА', 'A'),
		_Utils_Tuple2('àáâãåǻāăąǎªαάảạầấẫẩậằắẵẳặа', 'a'),
		_Utils_Tuple2('Б', 'B'),
		_Utils_Tuple2('б', 'b'),
		_Utils_Tuple2('ÇĆĈĊČ', 'C'),
		_Utils_Tuple2('çćĉċč', 'c'),
		_Utils_Tuple2('Д', 'D'),
		_Utils_Tuple2('д', 'd'),
		_Utils_Tuple2('ÐĎĐΔ', 'D'),
		_Utils_Tuple2('ðďđδ', 'd'),
		_Utils_Tuple2('ÈÉÊËĒĔĖĘĚΕΈẼẺẸỀẾỄỂỆЕЭ', 'E'),
		_Utils_Tuple2('èéêëēĕėęěέεẽẻẹềếễểệеэ', 'e'),
		_Utils_Tuple2('Ф', 'F'),
		_Utils_Tuple2('ф', 'f'),
		_Utils_Tuple2('ĜĞĠĢΓГҐ', 'G'),
		_Utils_Tuple2('ĝğġģγгґ', 'g'),
		_Utils_Tuple2('ĤĦ', 'H'),
		_Utils_Tuple2('ĥħ', 'h'),
		_Utils_Tuple2('ÌÍÎÏĨĪĬǏĮİΗΉΊΙΪỈỊИЫ', 'I'),
		_Utils_Tuple2('ìíîïĩīĭǐįıηήίιϊỉịиыї', 'i'),
		_Utils_Tuple2('Ĵ', 'J'),
		_Utils_Tuple2('ĵ', 'j'),
		_Utils_Tuple2('ĶΚК', 'K'),
		_Utils_Tuple2('ķκк', 'k'),
		_Utils_Tuple2('ĹĻĽĿŁΛЛ', 'L'),
		_Utils_Tuple2('ĺļľŀłλл', 'l'),
		_Utils_Tuple2('М', 'M'),
		_Utils_Tuple2('м', 'm'),
		_Utils_Tuple2('ÑŃŅŇΝН', 'N'),
		_Utils_Tuple2('ñńņňŉνн', 'n'),
		_Utils_Tuple2('ÒÓÔÕŌŎǑŐƠØǾΟΌΩΏỎỌỒỐỖỔỘỜỚỠỞỢО', 'O'),
		_Utils_Tuple2('òóôõōŏǒőơøǿºοόωώỏọồốỗổộờớỡởợо', 'o'),
		_Utils_Tuple2('П', 'P'),
		_Utils_Tuple2('п', 'p'),
		_Utils_Tuple2('ŔŖŘΡР', 'R'),
		_Utils_Tuple2('ŕŗřρр', 'r'),
		_Utils_Tuple2('ŚŜŞȘŠΣС', 'S'),
		_Utils_Tuple2('śŝşșšſσςс', 's'),
		_Utils_Tuple2('ȚŢŤŦτТ', 'T'),
		_Utils_Tuple2('țţťŧт', 't'),
		_Utils_Tuple2('ÙÚÛŨŪŬŮŰŲƯǓǕǗǙǛŨỦỤỪỨỮỬỰУ', 'U'),
		_Utils_Tuple2('ùúûũūŭůűųưǔǖǘǚǜυύϋủụừứữửựу', 'u'),
		_Utils_Tuple2('ÝŸŶΥΎΫỲỸỶỴЙ', 'Y'),
		_Utils_Tuple2('ýÿŷỳỹỷỵй', 'y'),
		_Utils_Tuple2('В', 'V'),
		_Utils_Tuple2('в', 'v'),
		_Utils_Tuple2('Ŵ', 'W'),
		_Utils_Tuple2('ŵ', 'w'),
		_Utils_Tuple2('ŹŻŽΖЗ', 'Z'),
		_Utils_Tuple2('źżžζз', 'z'),
		_Utils_Tuple2('ÆǼ', 'AE'),
		_Utils_Tuple2('ß', 'ss'),
		_Utils_Tuple2('Ĳ', 'IJ'),
...
var author$project$SwearWords$translationDict = elm$core$Dict$fromList(
	A2(
		elm$core$List$concatMap,
		function (_n0) {
			var accentedChars = _n0.a;
			var outputString = _n0.b;
			return A2(
				elm$core$List$map,
				function (c) {
					return _Utils_Tuple2(c, outputString);
				},
				elm$core$String$toList(accentedChars));
		},
		author$project$SwearWords$translationList));
...
var author$project$SwearWords$removeDiacritics = function (input) {
	var translateChar = function (c) {
		return A2(
			elm$core$Maybe$withDefault,
			elm$core$String$fromChar(c),
			A2(elm$core$Dict$get, c, author$project$SwearWords$translationDict));
	};
...
var author$project$SwearWords$words = elm$core$List$concat(
	_List_fromArray(
		[author$project$English$words, author$project$Czech$words]));
...
var author$project$SwearWords$severityOfMaybeSwearWordAdded = F2(
	function (oldString, newString) {
		var maybeLastWord = A2(
			...
			A2(
				...
				author$project$SwearWords$removeDiacritics),
			elm$core$String$toLower);
		var lastWord = function (string) {
			return A2(
				elm$core$Maybe$withDefault,
				'',
				maybeLastWord(string));
		};
		var newLastWord = lastWord(newString);
		var oldLastWord = lastWord(oldString);
		var maybeSeverity = function (_n0) {
			var swearWord = _n0.a;
			var severity_ = _n0.b;
			var normalizedSwearWord = A2(elm$core$Basics$composeR, elm$core$String$toLower, author$project$SwearWords$removeDiacritics)(swearWord);
			return (A2(elm$core$String$contains, normalizedSwearWord, newLastWord) && (!A2(elm$core$String$contains, normalizedSwearWord, oldLastWord))) ? elm$core$Maybe$Just(severity_) : elm$core$Maybe$Nothing;
		};
		var severities = A2(elm$core$List$filterMap, maybeSeverity, author$project$SwearWords$words);
		var severity = elm$core$List$sum(severities);
		return ((_Utils_cmp(
	...
	function (model, maxLength, stringGetter, stringSetter, newString) {
		if (_Utils_cmp(
			...
			var model_ = _Utils_update(
				model,
				{angerFlash: angerFlash, rageGuy: rageGuy});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Tick':
				var time = msg.a;
				var timePlusSeconds = function (seconds) {
				...
				return (_Utils_cmp(
					...
					elm$time$Time$posixToMillis(model.nextFetchMessages)) > 0) ? _Utils_Tuple2(
					_Utils_update(
						newModel,
						{
							nextFetchMessages: timePlusSeconds(30)
						}),
					A2(
						elm$core$Platform$Cmd$map,
						author$project$Main$DiscussionMsg,
						author$project$Discussion$fetchMessagesCmd(
			...
			case 'RageGuyMsg':
				...
				var oldAnger = model.rageGuy.targetAnger;
				var newRageGuy = A2(author$project$RageGuy$update, rageGuyMsg, model.rageGuy);
				var angerDiff = newRageGuy.targetAnger - oldAnger;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{angerFlash: (model.angerFlash + angerDiff) * 10.0, rageGuy: newRageGuy}),
					elm$core$Platform$Cmd$none);
			case 'ClickRageGuy':
				var rageGuy = model.rageGuy;
				var result = function () {
					if ((rageGuy.targetAnger >= 1.0) && ((!rageGuy.isRaging) && (!elm$core$String$isEmpty(model.message)))) {
						...
						if (rageGuy.isRaging && (rageGuy.thisMoodClock > 50)) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										...
										rageGuy: _Utils_update(
											rageGuy,
											{isRaging: false, mood: author$project$RageGuy$Neutral, targetAnger: 0.0})
									}),
								elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(
			...
			case 'MessageUpdate':
				...
				return _Utils_Tuple2(
					A5(
						author$project$Main$updatedModelRage,
						model,
						2000,
						function ($) {
							return $.message;
					...
					if (msg.a.a.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									discussion: A2(elm$core$List$cons, message, model.discussion)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						var error = msg.a.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									discussion: A2(
										elm$core$List$cons,
										A3(author$project$Main$restDbError, 'Error while posting message', error, model.time),
										model.discussion)
								}),
							elm$core$Platform$Cmd$none);
					}
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									discussion: A2(
										elm$core$List$cons,
										A3(author$project$Main$restDbError, 'Error while retrieving messages list', error, model.time),
										model.discussion)
								}),
							elm$core$Platform$Cmd$none);
					}
...
var author$project$Main$ClickRageGuy = {$: 'ClickRageGuy'};
var author$project$Main$MessageUpdate = function (a) {
	return {$: 'MessageUpdate', a: a};
};
var author$project$Main$RageGuyMsg = function (a) {
	return {$: 'RageGuyMsg', a: a};
};
var author$project$Main$TopicUpdate = function (a) {
	return {$: 'TopicUpdate', a: a};
};
...
var author$project$RageGuy$view = function (model) {
	var randomShifts = elm$core$Array$fromList(
		_List_fromArray(
			[-1, 2, 3, -2, 0, 2, -3, 1, 2, 1, 2, 1, 0, -1, -2, 2, 1, 0, 1, -3, 1, -2]));
	var randomShift = function (n) {
		return A2(
			elm$core$Maybe$withDefault,
			0,
			A2(
				...
				A2(
					...
					n + model.thisMoodClock),
				randomShifts));
	};
	var numberOfFFFRows = 5;
	var letterDiv = F3(
		function (xIndex, yIndex, letter) {
			var yPosition = ((yIndex * 30) + 15) + randomShift((xIndex * 7) + (yIndex * 5));
			var xPosition = ((xIndex * 20) + 390) + randomShift(((xIndex * 3) + (yIndex * 17)) * 35);
			return A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						...
						'left',
						elm$core$String$fromInt(xPosition) + 'px'),
						A2(
						elm$html$Html$Attributes$style,
						'top',
	...
	var rowDivs = F2(
		function (yIndex, letters) {
			return A2(
				elm$core$List$indexedMap,
				F2(
					function (xIndex, letter) {
						return A3(letterDiv, xIndex, yIndex, letter);
					}),
				letters);
		});
	var textDivs = function (texts) {
		return elm$core$List$concat(
			A2(
				elm$core$List$indexedMap,
				F2(
					function (yIndex, letters) {
						return A2(rowDivs, yIndex, letters);
					}),
				texts));
	};
	var index = author$project$RageGuy$startFrame(model.mood) + model.lastRelativeFrame;
	...
	var fffuuuTextDivs = function () {
		if (_Utils_eq(model.mood, author$project$RageGuy$FFFUUU)) {
			return textDivs(
			...
			if (model.targetAnger <= 0.0) {
				...
				var anger = model.targetAnger * 100.0;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(elm$html$Html$Attributes$style, 'background', 'url(\'img/RageGuySprites.jpg\') ' + (leftSpritePosition + ' 0px no-repeat'))
			]),
		fffuuuTextDivs);
};
var author$project$Utils$toRadix = function (n) {
	...
	return (n < 16) ? getChr(n) : _Utils_ap(
		author$project$Utils$toRadix((n / 16) | 0),
		getChr(
			A2(elm$core$Basics$modBy, 16, n)));
};
var author$project$Utils$toHex = function (n) {
	var hex = author$project$Utils$toRadix(n);
...
var author$project$Utils$rgb = F3(
	function (red, green, blue) {
		return {alpha: 255, blue: blue, green: green, red: red};
	});
...
var author$project$Main$view = function (model) {
	...
	var topicInput = A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$Attributes$value(model.topic),
	...
	var rageGuyView = A2(
		...
		_List_fromArray(
			[
				...
				author$project$RageGuy$view(model.rageGuy))
			]));
	...
	var viewMessage = function (message) {
		var username = elm$core$String$isEmpty(message.username) ? 'Anonymous' : message.username;
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(formatTime, model.zone, message.timestamp))
						])),
					A2(
					elm$html$Html$p,
					_List_fromArray(
	...
	var angerColor = function () {
		var now = elm$time$Time$posixToMillis(model.time);
		var interpolate = F3(
			function (start, end, ratio) {
				return elm$core$Basics$round(start + (ratio * (end - start)));
			});
		var interpolate3 = F5(
			function (a, b, c, d, p) {
				return (p < 0.0) ? a : ((p < 1.0) ? A3(interpolate, a, b, p) : ((p < 2.0) ? A3(interpolate, b, c, p - 1.0) : ((p < 3.0) ? A3(interpolate, c, d, p - 2.0) : d)));
			});
		var anger = (model.rageGuy.targetAnger < 1.0) ? model.angerFlash : ((!model.rageGuy.isRaging) ? ((((1.5 + elm$core$Basics$sin(now / 500.0)) + (0.5 * elm$core$Basics$sin(0.3 + (now / 400.0)))) + (0.4 * elm$core$Basics$cos(0.8 + (now / 300.0)))) + model.angerFlash) : (((1.0 + elm$core$Basics$sin(now / 500.0)) + (0.5 * elm$core$Basics$sin(0.3 + (now / 100.0)))) + (0.4 * elm$core$Basics$cos(0.8 + (now / 200.0)))));
		var angerColorComponent = F4(
			function (a, b, c, d) {
				return A5(interpolate3, a, b, c, d, anger);
			});
		return author$project$Utils$colorToHex(
			A3(
				author$project$Utils$rgb,
				A4(angerColorComponent, 255, 255, 192, 64),
				A4(angerColorComponent, 255, 128, 64, 32),
				A4(angerColorComponent, 255, 128, 64, 32)));
	}();
	return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('column'),
										elm$html$Html$Events$onClick(author$project$Main$ClickRageGuy)
									]),
								_List_fromArray(
									[rageGuyView]))
							])),
