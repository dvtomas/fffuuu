...
var author$project$RageGuy$framesDefinition = function (mood) {
	...
	switch (mood) {
		case 0:
			...
			return {
				u: staticFrames,
				v: elm$core$Dict$fromList(transitions)
			};
		case 1:
			return {
				u: _List_fromArray(
...
var author$project$RageGuy$maybeMoodTransitionFrameAfter = F2(
	function (lastFrame, mood) {
		return A2(
			elm$core$Dict$get,
			lastFrame,
			author$project$RageGuy$framesDefinition(mood).v);
	});
...
var author$project$Main$view = function (model) {
	...
	var angerColor = function () {
		var now = elm$time$Time$posixToMillis(model.U);
		var interpolate = F3(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2(elm$html$Html$hr, _List_Nil, _List_Nil),
							A2(elm$core$List$map, viewMessage, model.M)))
					]))
			]));
};
